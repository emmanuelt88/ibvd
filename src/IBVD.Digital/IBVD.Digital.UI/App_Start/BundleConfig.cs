...
namespace IBVD.Digital.UI
{
    public class BundleConfig
    {
        ...
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            bundles.Add(new ScriptBundle("~/bundles/SinglePageNav").Include(
            ...
            bundles.Add(new StyleBundle("~/bundles/Plugins/Slider").Include("~/Plugins/slider/jquery.flexslider.js"));
            ...
            bundles.Add(new StyleBundle("~/Content/css").Include("~/Content/font-awesome.min.css",
                "~/Content/templatemo_style.css","~/Content/bootstrap.min.css"));

            bundles.Add(new StyleBundle("~/Content/bootstrap").Include("~/Content/bootstrap.min.css"));

            bundles.Add(new StyleBundle("~/Content/Plugins/Slider").Include("~/Plugins/slider/flexslider.css"));
